#!/usr/bin/env python3
"""
Build script for Face Attended Backend using PyInstaller
...
def build_backend(debug=False, onefile=True, clean=True):
    ...
    print("Starting Face Attended Backend Build Process")
    print("=" * 50)
    ...
    cmd.append("face_attended_backend.spec")
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Build Face Attended Backend with PyInstaller")
