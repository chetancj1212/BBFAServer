@echo off
echo Starting Face Attended - Unified System Control (OpenVINO)
echo ==================================================
echo.

:: Start backend server
echo [1/4] Starting Backend Server (OpenVINO, port 8700)...
start "Backend Server (OpenVINO)" cmd /k "cd /d %~dp0server-vino && python main.py"
...
echo Backend API (OpenVINO):  http://localhost:8700
echo.
echo *** PUBLIC ACCESS ***
